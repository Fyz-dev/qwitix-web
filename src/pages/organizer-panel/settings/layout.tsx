        ...
        <div className="flex flex-1 flex-col space-y-2 overflow-hidden md:space-y-2 lg:flex-row lg:space-y-0 lg:space-x-12">
          <aside className="top-0 space-y-1 lg:sticky lg:w-1/5">
            <Button asChild variant="ghost">
              <Link
                href={Paths.Organizer.SettingsProfile}
                className={cn(
                  'hover:bg-muted w-full justify-start',
                  checkIsActive(pathname, Paths.Organizer.SettingsProfile) &&
                    'bg-muted',
                )}
              >
                <User />
            ...
            <Button asChild variant="ghost">
              <Link
                href={Paths.Organizer.SettingsAppearance}
                className={cn(
                  'hover:bg-muted w-full justify-start',
                  checkIsActive(pathname, Paths.Organizer.SettingsAppearance) &&
                    'bg-muted',
                )}
              >
                <Palette />
